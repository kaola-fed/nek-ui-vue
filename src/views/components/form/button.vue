<template>
    <div class="kl-content">
        ...
        <div class="kl-content__form-demo">
            <div class="float-block">
                <kl-demo title="按钮类型">
                    ...
                    <div slot="demo">
                        <button class="kl-btn" :class="$style['kl-primary']">主按钮</button>
                        <button class="kl-btn" :class="$style['kl-secondary']">次按钮</button>
                        <button class="kl-btn">弱按钮</button>
        ...
        <div class="kl-content-table">
            <h1>
                <a href="#API"  title="API"></a>API
            </h1>
            <div class="kl-content-table__detail">
                <h2>属性</h2>
                <table>
                    <thead>
                        <tr>
        ...
        <div class="kl-content-next">
            <router-link :to="{ name: 'docs'}"  class="kl-content-next__pager">
                <span class="icon"><i class="icon-left"></i></span>
                <span>按钮</span>
            </router-link >
